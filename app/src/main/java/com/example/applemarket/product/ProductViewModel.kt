...
class ProductViewModel : ViewModel() {
    ...
    var productList: LiveData<List<ProductModel>> = _productList
    ...
    init {
        _productList.value = arrayListOf(
            ...
            ProductModel(
                index, "sample${index++}", "김치냉장고", "이사로인해 내놔요", "안마담", 20000, "인천 계양구 귤현동", 8, 28
            ),
            ProductModel(
                index,
                "sample${index++}",
            ...
            ProductModel(
                index,
                "sample${index++}",
                "울산 동해오션뷰 60평 복층 펜트하우스 1일 숙박권 펜션 힐링 숙소 별장 울산 동해오션뷰 60평 복층 펜트하우스 1일 숙박권 펜션 힐링 숙소 별장 울산 동해오션뷰 60평 복층 펜트하우스 1일 숙박권 펜션 힐링 숙소 별장",
    ...
    fun toggleFavorite(position: Int) {
        ...
        if (position in 0 until currentList.size) {
            ...
            product.myFavorite = !product.myFavorite
            _productList.postValue(currentList)
        }
    }
}
